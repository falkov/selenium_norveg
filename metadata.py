...
# Table provides a single point of information regarding the structure of a table in a schema
# user_table.name

# The .c. attribute of Table is an associative array of Column objects, keyed on name
# user_table.c.name
# print(user_table.c)

# Column itself has information about each Column, such as name and type
# user_table.c.name.name
# user_table.c.name.type

# Table has other information available, such as the collection of columns which comprise the table's primary key
# user_table.primary_key

# The Table object is at the core of the SQL expression system - this is a quick preview of that
